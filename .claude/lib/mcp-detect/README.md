...
| Meta (oficial/Pipeboard) | receitas `sync-campaign-from-meta-official.md`, `sync-campaign-from-meta.md`, `pause-ad-set.md` + setup em `.claude/automations/setup-mcps.md` |
