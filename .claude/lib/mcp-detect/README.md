...
| **Notion** | `mcp__claude_ai_Notion__` (connector do claude.ai) ou `mcp__notion__` (registro local) | Banco de marcas da Skill 01 (uma página por marca + ranking) | Notion → `01-product-research/banco-de-marcas.html` na pasta do produto (o `.md` é salvo sempre) |
...
| `notion` | Banco de marcas salvo no Notion (Skill 01) |
...
| Notion | skill `01-product-research.md` (ETAPA 0 + SALVAR) + setup em `.claude/automations/setup-mcps.md` (3.9) |
