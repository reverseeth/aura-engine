...
.prog{{font-size:13px;color:var(--faint);font-weight:500;margin-bottom:6px;letter-spacing:0}}
.ordernote{{font-size:12px;color:var(--faint);margin-bottom:40px;letter-spacing:0;line-height:1.5}}
...
.b-post,.b-two{{font-size:9.5px;font-weight:600;text-transform:uppercase;letter-spacing:.06em;padding:2px 8px;border-radius:6px}}
.b-post{{color:#7C5CFF;background:rgba(124,92,255,.1)}}
.b-two{{color:#2849C9;background:rgba(45,91,255,.12)}}
...
<div class="ordernote reveal">{tr["order_note"]}</div>
{next_html}
