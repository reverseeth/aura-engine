...
- **Molde do breakthrough** (só quando ele tem `winning_mold_id`): com `mold_concepts_in_batch` igual a 1, o próximo batch leva **outro conceito no mesmo molde, com ângulo e persona diferentes** — é o teste que separa o mérito do esqueleto do mérito do ângulo. Com a contagem já maior que 1, escreva o que os conceitos daquele molde vêm entregando, e o molde passa a ser uma escolha deliberada da `creative-engine`, não coincidência.
