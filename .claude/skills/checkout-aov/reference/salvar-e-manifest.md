...
> O conteúdo do relatório, o dual output com as convenções, o schema do `checkout-aov/dados.json` com as notas de `aov_reconciliation` e `levers.bundles.tiers`, e a atualização do manifest pelo script. Abra ao fechar a skill.
